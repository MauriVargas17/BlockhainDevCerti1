...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () => new hdWallet(mnemonic, "https://rinkeby.infura.io/v3/fed32599b1474e359639ecaa4acf1f32"),
      network_id: "4",
      gas: 4500000,
      gasPrice: 1000000000
    },
    ...
    bscTestnet: {
      ...
      provider : () => new hdWallet(mnemonic, "https://data-seed-prebsc-1-s1.binance.org:8545/"),
      network_id: 97,
      confirmations: 10,
      timeoutBlocks: 200,
      skiDryRun: true
